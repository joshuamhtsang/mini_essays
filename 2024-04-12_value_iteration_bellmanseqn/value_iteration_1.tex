...
\begin{itemize}
    ...
    \begin{equation} \label{eqn:policy_formal_definition}
        \pi(s,a) = P(a=a|s=s)
    \end{equation}
    which is the probability of taking action $a$ given the system is in state $s$.  As a foreshadow, policy functions are often expressed as an $\argmax_a$ as follows:
